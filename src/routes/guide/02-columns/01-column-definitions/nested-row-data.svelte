<script lang="ts">
  ...
  const rowData = [
    ...
    },
    {
      ...
      medals: { gold: 6, silver: 0, bronze: 2 }
    },
    {
      name: 'Michael Phelps',
      person: { age: 27, country: 'United States' },
      medals: { gold: 4, silver: 2, bronze: 0 }
    },
    {
    ...
    },
    {
      ...
      medals: { gold: 1, silver: 3, bronze: 1 }
    },
    {
      name: 'Missy Franklin',
    ...
    },
    {
      ...
      medals: { gold: 2, silver: 0, bronze: 3 }
    },
    {
      name: 'Cindy Klassen',
    ...
    },
    {
      ...
      person: { age: 24, country: 'Zimbabwe' },
      medals: { gold: 1, silver: 3, bronze: 0 }
    },
    {
      name: 'Libby Lenton-Trickett',
      person: { age: 23, country: 'Australia' },
      medals: { gold: 2, silver: 1, bronze: 1 }
    },
    {
      name: 'Ryan Lochte',
      person: { age: 24, country: 'United States' },
      medals: { gold: 2, silver: 0, bronze: 2 }
    },
    {
      name: 'Inge de Bruijn',
      person: { age: 30, country: 'Netherlands' },
